  ...
  module Wombat
    module Jirafe
      describe OrderSerializer do
        ...
        before do
          # needed since the spree_jirafe extension adds these to the order
          Spree::Order.any_instance.stub(:visit_id){3423423423423}
          Spree::Order.any_instance.stub(:visitor_id){343433687578}
        end
